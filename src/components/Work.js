...
const Work = () => {
	return (
		<div className='work-bg-gradient relative h-[120vh] md:h-[200vh] w-full'>
			<div className='flex-column relative md:flex'>
				...
				<div className='relative flex w-[100vw] items-center justify-center md:w-[50vw]'>
			...
			<img src={images.photo2} alt='loading' className='object-cover bg-blend-normal absolute bottom-0' />
		</div>
	)
}
