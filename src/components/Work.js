		...
		<div className='work-bg-gradient relative w-full'>
			<div className='flex-column relative lg:flex'>
				<div className='h-[40vh] w-[100vw] overflow-hidden shadow-2xl lg:h-[60vh] lg:w-[50vw]'>
					<img src={images.photo1} alt='loading' className='h-full w-full object-cover lg:rounded-br-3xl' />
				</div>
				<div className='relative flex h-[40vh] w-[100vw] items-center justify-center lg:h-[60vh] lg:w-[50vw]'>
					...
					<h1 className='text-stroke w-3/4 items-center whitespace-nowrap text-[6.5vw] font-extrabold text-gray-50 lg:text-[3.3vw]'>
						<Typewriter
							options={{
								strings: ['Experienced Engineers.', 'Best Technologies.', 'Well-trained workers.', 'Best plans.'],
								autoStart: true,
								loop: true,
								delay: 200,
								deleteSpeed: 50,
			...
			<div className='relative mt-16 lg:mt-36'>
				...
				<div className='z-10 h-[100vh] scroll-mt-16' id='work'>
					<h1 className='text-stroke h-[15%] w-full text-center text-[5vmax] font-extrabold text-gray-50'>Our Works</h1>
					<Slider />
					<div className='h-[10%]'></div>
				</div>
				<img src={images.photo1} alt='loading' className='absolute bottom-0 z-[-1] h-[100vh] w-full object-cover pt-2 opacity-60 mix-blend-screen' />
			</div>
		</div>
	)
}
