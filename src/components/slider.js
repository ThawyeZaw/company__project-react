...
const Slider = () => {
	return (
		<div className='scrolling-wrapper flex h-[75%] items-center justify-center gap-8'>
			<Slide image={slide_image.slideImage1} size={'w-[40vw] h-[45vh]'} />
			<Slide image={slide_image.slideImage2} size={'w-[60vw] h-[70vh]'} />
			<Slide image={slide_image.slideImage3} size={'w-[40vw] h-[45vh]'} />
		</div>
	)
}
